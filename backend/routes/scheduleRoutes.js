...
router.get('/manager/', authenticateToken,  authentorizeRole([1, 3]), scheduleController.getScheduleByDepartment);
router.get('/hr', authenticateToken,  authentorizeRole([1]), scheduleController.getScheduleGlobal);
